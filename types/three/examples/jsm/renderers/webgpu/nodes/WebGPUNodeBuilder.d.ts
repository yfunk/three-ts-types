...
class WebGPUNodeBuilder<
    TMaterial extends Material = Material,
    TRenderer extends Renderer = Renderer
> extends NodeBuilder<TMaterial, TRenderer> {
    bindings: any;
    bindingsOffset: { vertex: number; fragment: number };

    uniformsGroup: object;
    ...
    getAttributesHeaderSnippet: (shaderStage: string) => string;

    getVarysHeaderSnippet: (shaderStage: string) => string;

    getVarysBodySnippet: (shaderStage: string) => string;

    getUniformsHeaderSnippet: (shaderStage: string) => string;
