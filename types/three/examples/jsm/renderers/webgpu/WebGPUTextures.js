    ...
    _getFormat(texture) {
        ...
        switch (format) {
            case RGBA_S3TC_DXT1_Format:
                formatGPU =
                    encoding === sRGBEncoding ? GPUTextureFormat.BC1RGBAUnormSRGB : GPUTextureFormat.BC1RGBAUnorm;
                break;

            case RGBA_S3TC_DXT3_Format:
                formatGPU =
                    encoding === sRGBEncoding ? GPUTextureFormat.BC2RGBAUnormSRGB : GPUTextureFormat.BC2RGBAUnorm;
                break;

            case RGBA_S3TC_DXT5_Format:
                formatGPU =
                    encoding === sRGBEncoding ? GPUTextureFormat.BC3RGBAUnormSRGB : GPUTextureFormat.BC3RGBAUnorm;
                break;
            ...
            case RGBAFormat:
                switch (type) {
                    case UnsignedByteType:
                        formatGPU =
                            encoding === sRGBEncoding ? GPUTextureFormat.RGBA8UnormSRGB : GPUTextureFormat.RGBA8Unorm;
                        break;
